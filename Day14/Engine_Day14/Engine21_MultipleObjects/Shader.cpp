...
bool ShaderUtil::VertexShader::BindShader(ID3D11Device* pDevice, ID3D11DeviceContext* pDeviceContext)
{
	if (!ShaderUtil::BindVertexShader(
		pDevice, pDeviceContext, pShaderBuffer->GetBufferPointer(),
...
bool ShaderUtil::PixelShader::BindShader(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	if (!ShaderUtil::BindPixelShader(
		pDevice, pDeviceContext, pShaderBuffer->GetBufferPointer(),
