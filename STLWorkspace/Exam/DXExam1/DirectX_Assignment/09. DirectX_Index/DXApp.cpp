...
bool DXApp::InitScene()
{
	...
	{
		// Front Face
		Vertex(-1.0f, -1.0f, -1.0f, 1.0f, 0.5f,1.0f,0.0f),
		Vertex(-1.0f,  1.0f, -1.0f, 0.0f, 1.0f,1.0f,0.0f),
		...
		Vertex(1.0f,  1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 0.0f),
		Vertex(-1.0f,  1.0f, 1.0f, 0.3f, 1.0f, 0.0f, 0.0f),
