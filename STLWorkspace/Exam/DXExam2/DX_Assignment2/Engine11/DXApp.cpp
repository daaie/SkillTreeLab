...
void DXApp::InitMeshInfo()
{
	...
	// 정점 쉐이더.
	sphereMesh.vertexShader = ShaderUtil::VertexShader(L"Shaders//ToonVS.fx", "main", "vs_5_0");
	sphereMesh.pixelShader = ShaderUtil::PixelShader(L"Shaders//ToonPS.fx", "main", "ps_5_0");
