...
void DXApp::InitMeshInfo()
{
	...
	// 정점 쉐이더.
	sphereMesh.vertexShader = ShaderUtil::VertexShader(L"Shaders//NormalVS.fx", "main", "vs_5_0");
	sphereMesh.pixelShader = ShaderUtil::PixelShader(L"Shaders//NormalPS.fx", "main", "ps_5_0");
