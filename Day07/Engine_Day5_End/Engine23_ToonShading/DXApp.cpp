...
DXApp::DXApp(HINSTANCE hinstance)
{
	...
	clientWidth = 1280;
	clientHeight = 800;
	appTitle = L"Engine24 - Engine Update";
...
void DXApp::InitProjectionMatrix(Shape::Mesh * mesh)
{
	...
	// 투영 행렬.
	projection = XMMatrixPerspectiveFovLH(fovY, (float)clientWidth / (float)clientHeight, 1.0f, 10000.0f);
}
...
void DXApp::InitMeshInfo()
{
	...
	LPCSTR fbxNameCardBoard = "Resources//Model//SK_CharM_FrostGiant.FBX";
	LPCSTR fbxPlane = "Resources//Model//plane.fbx";
	...
	cardDiffuse.fileName = L"Resources//Textures//T_Char_M_FrostGiant_D.png";
	ShaderUtil::Texture cardNormal;
	cardNormal.fileName = L"Resources//Textures//T_Char_M_FrostGiant_N.png";

	ShaderUtil::Texture planeDiffuse;
	planeDiffuse.fileName = L"Resources//Textures//T_ground_Moss_D.png";

	Shape::Mesh skyMesh;
	skyMesh.fbxName = "Resources//Model//sphere.fbx";
	skyMesh.vertexShader = ShaderUtil::VertexShader(L"Shaders//SkyboxVS.fx", "main", "vs_5_0");
	skyMesh.pixelShader = ShaderUtil::PixelShader(L"Shaders//SkyboxPS.fx", "main", "ps_5_0");
	//skyMesh.pixelShader.pTextures.push_back(diffuseMap);
	//skyMesh.pixelShader.pTextures.push_back(normalMap);
	skyMesh.pixelShader.pTextures.push_back(cubeMap);

	skyMesh.scale = XMFLOAT3(100.0f, 100.0f, 100.0f);
	...
	planeMesh.pixelShader.pTextures.push_back(planeDiffuse);
	...
	cardboardMesh.scale = XMFLOAT3(0.1f, 0.1f, 0.1f);
	...
	diffuseMesh.scale = XMFLOAT3(0.1f, 0.1f, 0.1f);
	...
	normalMesh.scale = XMFLOAT3(0.1f, 0.1f, 0.1f);
